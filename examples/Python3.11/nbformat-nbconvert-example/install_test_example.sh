...
python3.11 -m pip install --no-cache --prefer-binary --extra-index-url https://wheels.developerfirst.ibm.com/ppc64le/linux-v2026.06.0 -r requirements.txt
...
# Run Python scripts
printf "\nRunning example.py\n"
python3.11 nbformat_nbconvert_example.py
...
python3.11 sub-test4.py

printf "\nRunning sub-test5.py\n"
python3.11 sub-test5.py
