...
case $DISTRO in
    "fedora"|"rhel"|"centos"|"rocky"|"almalinux")
        if command -v dnf >/dev/null 2>&1; then
            sudo dnf install gcc-toolset-13 python3.11-devel python3.11-pip libjpeg-turbo-devel numactl gcc gcc-c++ gcc-gfortran xz cmake yum-utils openssl-devel openblas-devel bzip2-devel bzip2 libffi-devel \
            ...
            sudo yum install gcc-toolset-13 python3.11-devel python3.11-pip libjpeg-turbo-devel numactl gcc gcc-c++ gcc-gfortran xz cmake yum-utils openssl-devel openblas-devel bzip2-devel bzip2 libffi-devel \
            zlib-devel autoconf automake libtool cargo \
    ...
    "ubuntu"|"debian")
        ...
        gcc g++ gfortran python3.11 python3.11-dev python3.11-venv python3-pip \
