...
python3.12 -m pip install --no-cache --prefer-binary --extra-index-url https://wheels.developerfirst.ibm.com/ppc64le/linux-v2026.03.31 -r requirements.txt

WORKDIR=$(pwd)

cd $WORKDIR

python3.12 treesitter_example.py
