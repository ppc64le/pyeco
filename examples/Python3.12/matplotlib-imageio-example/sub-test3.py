# sub-test3.py
# Independent deeper test:
#  - Validates figure pixel size vs (figsize * dpi)
#  - Exercises alpha overlay + safe JPEG export
#  - Adds/reads PNG text metadata (Pillow)
#  - Generates a small batch with varying DPI
#  - Prints a consolidated result summary
